#include "gui_t_vs_E_analysis_frame.h"
...
//namespace RhodotronSimulatorGUI::frames::subframes{
    ...
    void TvsEControlFrame::Setup(){
        b_index->Connect("Modified()", "AnalysisFrame", (void*)parent, 
                             "TvsERequested()");
        e_index->Connect("Modified()", "AnalysisFrame", (void*)parent, 
                             "TvsERequested()");
    }
    ...
    void TvsEControlFrame::SetTimeInterval(double start_time, double end_time){
        ...
        time_interval_select->Connect("PositionChanged()","AnalysisFrame", (void*)parent, "TvsERequested()");
    }
